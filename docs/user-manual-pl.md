...
![Strona Rejestracji](img/04-register.png)
...
![Strona Logowania](img/03-login.png)
...
![Lista Aukcji](img/02-auctions-listing.png)
...
![Szczegóły Aukcji](img/08-auction-detail.png)
...
![Panel Użytkownika](img/14-user-dashboard.png)
...
![Panel Administratora](img/09-admin-dashboard.png)
...
![Lista Aukcji Administratora](img/10-admin-auctions.png)
...
![Formularz Aukcji](img/11-admin-auction-form.png)
...
![Ustawienia Administratora](img/13-admin-settings.png)
...
![Strona Importu](img/12-admin-import.png)
